$(document).ready(function(){
    ...
    var myKey = "b1095e725c3b8f639dd108daa43ac5c9";
    ...
    function w_info(){
        ...
        //배열데이터의 갯수를 기준으로 w_box 라는 리스트 항목을 넣어준다.
            ...
            $("#weather li").each(function(index){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        var humidity = data.main.humidity; //데이터로부터 main의 배열인 humidity 정보를 가져오겠다.
                        ...
                        // console.log(this); //{url: 'https://api.openweathermap.org/data/2.5/weather?q=Seoul&appid=b1095e725c3b8f639dd108daa43ac5c9', type: 'GET', isLocal: false, global: true, processData: true, …}
    ...
    */
    ...
    $(document).on("click", ".cities button", function(){
        ...
        //city.push($city_txt); //클릭한 버튼의 텍스트를 city라는 배열데이터의 마지막 자리에 위치를 시킨다. ==> 마지막에 클릭한 버튼의 데이터 정보는 리스트 중에서 맨 마지막에 나온다.
        city.unshift($city_txt); //클릭한 버튼의 텍스트를 city라는 배열데이터의 첫번째 자리에 위치를 시킨다. ==> 마지막에 클릭한 버튼의 데이터 정보는 리스트 중에서 맨 처음에 나온다.
    ...
    function search(){
        ...
        if($search_val.trim() == ""){ //입력한 값이 없거나 공백만 존재할 경우
            alert("검색어를 입력하세요.");
        }else{
